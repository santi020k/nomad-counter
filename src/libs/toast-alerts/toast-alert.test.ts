...
describe(
  ...
  () => {
    ...
    it(
      'toastAlert calls Toastify with correct parameters',
      () => {
    ...
    it(
      'toastSuccess calls toastAlert with correct parameters',
      () => {
    ...
    it(
      'toastError calls toastAlert with correct parameters',
      () => {
